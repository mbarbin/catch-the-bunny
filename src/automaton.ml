...
module Step = struct
  (* There seems to be an expression generated by [sexp_of] that triggers a
     coverage alert, even though all cases of the variant are printed as sexps
     in the tests. As a workaround, the coverage is disabled for the module. *)
  [@@@coverage off]
